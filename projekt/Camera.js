...
export class Camera extends Node {
    ...
    mouseUpHandler(e){
        ...
        quat.set(arrowNode.rotation, 0, 0, 0, 1);
        ...
        const up = vec3.set(vec3.create(),
            -Math.sin(c.rotation[0])*strength, Math.sin(c.rotation[0])*strength, 0);
        ...
        // //make arrow always come out of camera middle vec3.fromValues(-0.4,0,2)
