...
export class Renderer {
    ...
    getViewProjectionMatrix(camera) {
        ...
        //you do this instead of getGlobalTransform
        while (parent) {
    ...
    //camera.matrix = node (camera position in space) (view matrix that maps from model to camera)?
    //camera.camera.matrix = projection matrix that always stays the same?
    ...
    renderNode(node, mvpMatrix) {
        ...
        //node.matrix is like node.transform from previous examples
